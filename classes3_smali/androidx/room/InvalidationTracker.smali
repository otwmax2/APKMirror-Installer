...
.field private final onRefreshCompleted:Lsa/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lsa/a<",
            "Ls9/u2;",
...
.field private final onRefreshScheduled:Lsa/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lsa/a<",
            "Ls9/u2;",
...
.method static constructor <clinit>()V
    ...
    .line 4
    invoke-direct {v0, v1}, Landroidx/room/InvalidationTracker$Companion;-><init>(Lkotlin/jvm/internal/x;)V
...
.method public varargs constructor <init>(Landroidx/room/RoomDatabase;Ljava/util/Map;Ljava/util/Map;[Ljava/lang/String;)V
    ...
    .line 9
    invoke-direct/range {v1 .. v7}, Landroidx/room/TriggerBasedInvalidationTracker;-><init>(Landroidx/room/RoomDatabase;Ljava/util/Map;Ljava/util/Map;[Ljava/lang/String;ZLsa/l;)V
    ...
    invoke-direct {p1, p0}, Landroidx/room/f;-><init>(Landroidx/room/InvalidationTracker;)V

    iput-object p1, p0, Landroidx/room/InvalidationTracker;->onRefreshScheduled:Lsa/a;

    .line 13
    new-instance p1, Landroidx/room/g;

    invoke-direct {p1, p0}, Landroidx/room/g;-><init>(Landroidx/room/InvalidationTracker;)V

    iput-object p1, p0, Landroidx/room/InvalidationTracker;->onRefreshCompleted:Lsa/a;
    ...
    invoke-direct {p1, p0}, Landroidx/room/h;-><init>(Landroidx/room/InvalidationTracker;)V

    invoke-virtual {v1, p1}, Landroidx/room/TriggerBasedInvalidationTracker;->setOnAllowRefresh$room_runtime(Lsa/a;)V
...
.method public static synthetic a(Landroidx/room/InvalidationTracker;)Ls9/u2;
    .registers 1

    .line 1
    invoke-static {p0}, Landroidx/room/InvalidationTracker;->onRefreshCompleted$lambda$1(Landroidx/room/InvalidationTracker;)Ls9/u2;
...
.method public static final synthetic access$getOnRefreshCompleted$p(Landroidx/room/InvalidationTracker;)Lsa/a;
    .registers 1

    .line 1
    iget-object p0, p0, Landroidx/room/InvalidationTracker;->onRefreshCompleted:Lsa/a;

    .line 3
    return-object p0
.end method

.method public static final synthetic access$getOnRefreshScheduled$p(Landroidx/room/InvalidationTracker;)Lsa/a;
    .registers 1

    .line 1
    iget-object p0, p0, Landroidx/room/InvalidationTracker;->onRefreshScheduled:Lsa/a;
...
.method private final addObserverOnly(Landroidx/room/InvalidationTracker$Observer;)Z
    ...
    .line 7
    invoke-virtual {v0, v1}, Landroidx/room/TriggerBasedInvalidationTracker;->validateTableNames$room_runtime([Ljava/lang/String;)Ls9/z0;
    ...
    .line 43
    invoke-static {v2, p1}, Lu9/n1;->K(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast p1, Landroidx/room/ObserverWrapper;
    :try_end_3b
    .catchall {:try_start_20 .. :try_end_3b} :catchall_31
    ...
    .line 67
    invoke-virtual {p1, v0}, Landroidx/room/TriggerBasedInvalidationTracker;->onObserverAdded$room_runtime([I)Z
...
.method public static synthetic c(Landroidx/room/InvalidationTracker;)Ls9/u2;
    .registers 1

    .line 1
    invoke-static {p0}, Landroidx/room/InvalidationTracker;->onRefreshScheduled$lambda$0(Landroidx/room/InvalidationTracker;)Ls9/u2;
...
.method public static synthetic createFlow$default(Landroidx/room/InvalidationTracker;[Ljava/lang/String;ZILjava/lang/Object;)Lqb/i;
    .registers 5
...
.method private final notifyInvalidatedObservers(Ljava/util/Set;)V
    ...
    .line 37
    invoke-virtual {v1, p1}, Landroidx/room/ObserverWrapper;->notifyByTableIds$room_runtime(Ljava/util/Set;)V
...
.method private final onAutoCloseCallback()V
    ...
    .line 57
    invoke-virtual {v1}, Landroidx/room/TriggerBasedInvalidationTracker;->resetSync$room_runtime()V

    .line 60
    sget-object v1, Ls9/u2;->a:Ls9/u2;
    :try_end_3d
    .catchall {:try_start_3 .. :try_end_3d} :catchall_2b
...
.method private static final onRefreshCompleted$lambda$1(Landroidx/room/InvalidationTracker;)Ls9/u2;
    .registers 1
...
.method private static final onRefreshScheduled$lambda$0(Landroidx/room/InvalidationTracker;)Ls9/u2;
    .registers 1
...
.method private final removeObserverOnly(Landroidx/room/InvalidationTracker$Observer;)Z
    ...
    .line 25
    invoke-virtual {v0, p1}, Landroidx/room/TriggerBasedInvalidationTracker;->onObserverRemoved$room_runtime([I)Z
...
.method public addObserver(Landroidx/room/InvalidationTracker$Observer;)V
    ...
    .line 15
    invoke-direct {p1, p0, v0}, Landroidx/room/InvalidationTracker$addObserver$1;-><init>(Landroidx/room/InvalidationTracker;Lda/f;)V

    .line 18
    invoke-static {p1}, Landroidx/room/coroutines/RunBlockingUninterruptible_androidKt;->runBlockingUninterruptible(Lsa/p;)Ljava/lang/Object;
...
.method public final varargs createFlow([Ljava/lang/String;)Lqb/i;
    .registers 5
    ...
    invoke-static {p0, p1, v2, v0, v1}, Landroidx/room/InvalidationTracker;->createFlow$default(Landroidx/room/InvalidationTracker;[Ljava/lang/String;ZILjava/lang/Object;)Lqb/i;
...
.method public final createFlow([Ljava/lang/String;Z)Lqb/i;
    .registers 5
    .param p1  # [Ljava/lang/String;
        .annotation build Lke/l;
        .end annotation
    ...
    invoke-virtual {v0, p1}, Landroidx/room/TriggerBasedInvalidationTracker;->validateTableNames$room_runtime([Ljava/lang/String;)Ls9/z0;
    ...
    invoke-virtual {v1, v0, p1, p2}, Landroidx/room/TriggerBasedInvalidationTracker;->createFlow$room_runtime([Ljava/lang/String;[IZ)Lqb/i;
    ...
    invoke-virtual {p2, v0}, Landroidx/room/MultiInstanceInvalidationClient;->createFlow([Ljava/lang/String;)Lqb/i;
    ...
    invoke-static {v0}, Lqb/k;->c1([Lqb/i;)Lqb/i;
...
.method public final createLiveData([Ljava/lang/String;ZLsa/l;)Landroidx/lifecycle/LiveData;
    .registers 5
    .param p1  # [Ljava/lang/String;
        .annotation build Lke/l;
        .end annotation
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroidx/room/InvalidationLiveDataContainer;->create([Ljava/lang/String;ZLsa/l;)Landroidx/lifecycle/LiveData;
...
.method public final internalInit$room_runtime(Landroidx/sqlite/SQLiteConnection;)V
    ...
    throw v1
    :try_end_25
    .catchall {:try_start_d .. :try_end_25} :catchall_1b
...
.method public final notifyObserversByTableNames$room_runtime(Ljava/util/Set;)V
    ...
    move-result-object v1
    :try_end_16
    .catchall {:try_start_a .. :try_end_16} :catchall_38
    ...
    .line 42
    invoke-virtual {v1}, Landroidx/room/ObserverWrapper;->getObserver$room_runtime()Landroidx/room/InvalidationTracker$Observer;

    .line 45
    move-result-object v2

    .line 46
    invoke-virtual {v2}, Landroidx/room/InvalidationTracker$Observer;->isRemote$room_runtime()Z
    ...
    .line 52
    invoke-virtual {v1, p1}, Landroidx/room/ObserverWrapper;->notifyByTableNames$room_runtime(Ljava/util/Set;)V
...
.method public final refresh([Ljava/lang/String;Lda/f;)Ljava/lang/Object;
    .registers 6
    .param p1  # [Ljava/lang/String;
        .annotation build Lke/l;
        .end annotation
    ...
    .line 3
    iget-object v1, p0, Landroidx/room/InvalidationTracker;->onRefreshScheduled:Lsa/a;

    .line 5
    iget-object v2, p0, Landroidx/room/InvalidationTracker;->onRefreshCompleted:Lsa/a;

    .line 7
    invoke-virtual {v0, p1, v1, v2, p2}, Landroidx/room/TriggerBasedInvalidationTracker;->refreshInvalidation$room_runtime([Ljava/lang/String;Lsa/a;Lsa/a;Lda/f;)Ljava/lang/Object;
...
.method public final refreshAsync()V
    ...
    .line 7
    invoke-virtual {v0, v1, v2}, Landroidx/room/TriggerBasedInvalidationTracker;->refreshInvalidationAsync$room_runtime(Lsa/a;Lsa/a;)V
...
.method public refreshVersionsSync()V
    ...
    .line 4
    invoke-direct {v0, p0, v1}, Landroidx/room/InvalidationTracker$refreshVersionsSync$1;-><init>(Landroidx/room/InvalidationTracker;Lda/f;)V
...
.method public removeObserver(Landroidx/room/InvalidationTracker$Observer;)V
    ...
    .line 15
    invoke-direct {p1, p0, v0}, Landroidx/room/InvalidationTracker$removeObserver$1;-><init>(Landroidx/room/InvalidationTracker;Lda/f;)V
...
.method public final setAutoCloser$room_runtime(Landroidx/room/support/AutoCloser;)V
    ...
    .line 13
    invoke-virtual {p1, v0}, Landroidx/room/support/AutoCloser;->setAutoCloseCallback(Lsa/a;)V
...
.method public final sync$room_runtime(Lda/f;)Ljava/lang/Object;
    .registers 3
    .param p1  # Lda/f;
        .annotation build Lke/l;
        .end annotation
    ...
    .line 3
    invoke-virtual {v0, p1}, Landroidx/room/TriggerBasedInvalidationTracker;->syncTriggers$room_runtime(Lda/f;)Ljava/lang/Object;
...
.method public final syncBlocking$room_runtime()V
    ...
    .line 4
    invoke-direct {v0, p0, v1}, Landroidx/room/InvalidationTracker$syncBlocking$1;-><init>(Landroidx/room/InvalidationTracker;Lda/f;)V
