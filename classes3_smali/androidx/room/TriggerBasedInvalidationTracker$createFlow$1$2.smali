...
# instance fields
.field final synthetic $$this$flow:Lqb/j;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lqb/j<",
            "Ljava/util/Set<",
...
.field final synthetic $currentVersions:Lkotlin/jvm/internal/l1$h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method public constructor <init>(Lkotlin/jvm/internal/l1$h;ZLqb/j;[Ljava/lang/String;[I)V
    .registers 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iput-object p1, p0, Landroidx/room/TriggerBasedInvalidationTracker$createFlow$1$2;->$currentVersions:Lkotlin/jvm/internal/l1$h;

    .line 3
    iput-boolean p2, p0, Landroidx/room/TriggerBasedInvalidationTracker$createFlow$1$2;->$emitInitialState:Z

    .line 5
    iput-object p3, p0, Landroidx/room/TriggerBasedInvalidationTracker$createFlow$1$2;->$$this$flow:Lqb/j;
...
.method public bridge synthetic emit(Ljava/lang/Object;Lda/f;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/room/TriggerBasedInvalidationTracker$createFlow$1$2;->emit([ILda/f;)Ljava/lang/Object;
...
.method public final emit([ILda/f;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Landroidx/room/TriggerBasedInvalidationTracker$createFlow$1$2$emit$1;-><init>(Landroidx/room/TriggerBasedInvalidationTracker$createFlow$1$2;Lda/f;)V
    ...
    .line 3
    iget-object p2, p0, Landroidx/room/TriggerBasedInvalidationTracker$createFlow$1$2;->$currentVersions:Lkotlin/jvm/internal/l1$h;
    ...
    .line 5
    iget-object p2, p0, Landroidx/room/TriggerBasedInvalidationTracker$createFlow$1$2;->$$this$flow:Lqb/j;

    iget-object v2, p0, Landroidx/room/TriggerBasedInvalidationTracker$createFlow$1$2;->$resolvedTableNames:[Ljava/lang/String;

    invoke-static {v2}, Lu9/a0;->Fz([Ljava/lang/Object;)Ljava/util/Set;
    ...
    .line 9
    iget-object v11, p2, Lkotlin/jvm/internal/l1$h;->p:Ljava/lang/Object;
    ...
    invoke-static {v5}, Lu9/r0;->f6(Ljava/lang/Iterable;)Ljava/util/Set;
