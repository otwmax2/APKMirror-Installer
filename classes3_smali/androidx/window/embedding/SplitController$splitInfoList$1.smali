...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/window/embedding/SplitController;->splitInfoList(Landroid/app/Activity;)Lqb/i;
.end annotation
...
# direct methods
.method public constructor <init>(Landroidx/window/embedding/SplitController;Landroid/app/Activity;Lda/f;)V
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static synthetic i(Landroidx/window/embedding/SplitController;Landroidx/core/util/Consumer;)Ls9/u2;
    .registers 2

    .line 1
    invoke-static {p0, p1}, Landroidx/window/embedding/SplitController$splitInfoList$1;->invokeSuspend$lambda$1(Landroidx/window/embedding/SplitController;Landroidx/core/util/Consumer;)Ls9/u2;
...
.method private static final invokeSuspend$lambda$0(Lob/j0;Ljava/util/List;)V
    .registers 2
...
.method private static final invokeSuspend$lambda$1(Landroidx/window/embedding/SplitController;Landroidx/core/util/Consumer;)Ls9/u2;
    .registers 2
...
.method public static synthetic k(Lob/j0;Ljava/util/List;)V
    .registers 2

    .line 1
    invoke-static {p0, p1}, Landroidx/window/embedding/SplitController$splitInfoList$1;->invokeSuspend$lambda$0(Lob/j0;Ljava/util/List;)V
...
.method public final create(Ljava/lang/Object;Lda/f;)Lda/f;
    ...
    .line 7
    invoke-direct {v0, v1, v2, p2}, Landroidx/window/embedding/SplitController$splitInfoList$1;-><init>(Landroidx/window/embedding/SplitController;Landroid/app/Activity;Lda/f;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/embedding/SplitController$splitInfoList$1;->invoke(Lob/j0;Lda/f;)Ljava/lang/Object;
...
.method public final invoke(Lob/j0;Lda/f;)Ljava/lang/Object;
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Landroidx/window/embedding/SplitController$splitInfoList$1;->create(Ljava/lang/Object;Lda/f;)Lda/f;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 31
    new-instance v1, Landroidx/window/embedding/t2;

    .line 33
    invoke-direct {v1, p1}, Landroidx/window/embedding/t2;-><init>(Lob/j0;)V
    ...
    .line 54
    new-instance v4, Landroidx/window/embedding/u2;

    .line 56
    invoke-direct {v4, v3, v1}, Landroidx/window/embedding/u2;-><init>(Landroidx/window/embedding/SplitController;Landroidx/core/util/Consumer;)V
