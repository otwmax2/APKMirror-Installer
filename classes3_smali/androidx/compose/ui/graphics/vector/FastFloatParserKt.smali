...
.method public static final nextFloat(Ljava/lang/String;II)J
    ...
    .line 21
    invoke-static/range {v19 .. v20}, Ls9/k2;->h(J)J
    ...
    invoke-static {v7, v8, v4, v5}, Landroidx/collection/b;->a(JJ)I
    ...
    if-gt v4, v8, :cond_260

    const/16 v4, 0xb

    if-ge v8, v4, :cond_260
    ...
    if-gt v4, v8, :cond_334

    const/16 v4, 0x80

    if-ge v8, v4, :cond_334
    ...
    invoke-static {v4, v6}, Ls9/l2;->k([JI)J
