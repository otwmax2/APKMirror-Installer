...
.method public constructor <init>(Lj$/util/stream/a;Lj$/util/stream/s3;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)V
    ...
    .line 1181
    iput-object p1, p0, Lj$/util/stream/z8;->j:Lj$/util/stream/a;

    .line 1182
    iput-object p4, p0, Lj$/util/stream/z8;->k:Ljava/util/function/IntFunction;
    ...
    iput-boolean p1, p0, Lj$/util/stream/z8;->l:Z

    return-void
.end method

.method public constructor <init>(Lj$/util/stream/z8;Lj$/util/Spliterator;)V
    .registers 3
    ...
    .line 1188
    iget-object p2, p1, Lj$/util/stream/z8;->j:Lj$/util/stream/a;

    iput-object p2, p0, Lj$/util/stream/z8;->j:Lj$/util/stream/a;

    .line 1189
    iget-object p2, p1, Lj$/util/stream/z8;->k:Ljava/util/function/IntFunction;

    iput-object p2, p0, Lj$/util/stream/z8;->k:Ljava/util/function/IntFunction;

    .line 1190
    iget-boolean p1, p1, Lj$/util/stream/z8;->l:Z
...
.method public final a()Ljava/lang/Object;
    ...
    iget-object v3, p0, Lj$/util/stream/z8;->k:Ljava/util/function/IntFunction;
    ...
    .line 1206
    iget-object v1, p0, Lj$/util/stream/z8;->j:Lj$/util/stream/a;
    ...
    iput-boolean v1, p0, Lj$/util/stream/z8;->n:Z
    ...
    iput-wide v1, p0, Lj$/util/stream/z8;->m:J
...
.method public final c(Lj$/util/Spliterator;)Lj$/util/stream/d;
    ...
    invoke-direct {v0, p0, p1}, Lj$/util/stream/z8;-><init>(Lj$/util/stream/z8;Lj$/util/Spliterator;)V
...
.method public final f()V
    ...
    .line 1267
    iget-boolean v0, p0, Lj$/util/stream/z8;->l:Z

    if-eqz v0, :cond_18

    iget-boolean v0, p0, Lj$/util/stream/z8;->o:Z

    if-eqz v0, :cond_18

    .line 1200
    iget-object v0, p0, Lj$/util/stream/z8;->j:Lj$/util/stream/a;
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    iget-boolean v0, v0, Lj$/util/stream/z8;->n:Z

    iget-object v1, p0, Lj$/util/stream/d;->e:Lj$/util/stream/d;

    check-cast v1, Lj$/util/stream/z8;

    iget-boolean v1, v1, Lj$/util/stream/z8;->n:Z

    or-int/2addr v0, v1

    iput-boolean v0, p0, Lj$/util/stream/z8;->n:Z
    ...
    iget-boolean v3, v0, Lj$/util/stream/z8;->n:Z

    if-eqz v3, :cond_41

    .line 1231
    iget-wide v1, v0, Lj$/util/stream/z8;->m:J
    ...
    iget-wide v3, v0, Lj$/util/stream/z8;->m:J

    iget-object v5, p0, Lj$/util/stream/d;->e:Lj$/util/stream/d;

    check-cast v5, Lj$/util/stream/z8;

    iget-wide v6, v5, Lj$/util/stream/z8;->m:J

    add-long/2addr v3, v6

    iput-wide v3, p0, Lj$/util/stream/z8;->m:J
    ...
    .line 1252
    :cond_5d
    iget-wide v3, v5, Lj$/util/stream/z8;->m:J
    ...
    check-cast v2, Lj$/util/stream/z8;
    ...
    .line 1242
    iput-boolean v0, p0, Lj$/util/stream/z8;->o:Z
